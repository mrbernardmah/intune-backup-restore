::Name - Backup Script
::Description - Backs Up favourites,signatures, Outlook settings, templates, UI settings, stickynotes, chrome bookmarks, email signature and mapped drives from local PC to OneDrive
...
md C:\Backup1
cmd /c xcopy Backup1.txt C:\Backup1
